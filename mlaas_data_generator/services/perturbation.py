...
def run_perturbation_stage(
    ...
    *,
    ...
    returns a compact error metric instead of failing the service record.
    """
    config = config or {}
    ...
    seed = _stable_seed(config.get("seed", 42), service_id, task_family, hf_task)
    ...
    _progress_log(
        config,
        "stage starts | "
        f"service_id={service_id or 'unknown'} "
